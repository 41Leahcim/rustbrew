...
Count all programs written/built in Go/Rust/Python/.. and distributed via Homebrew. A translation of [gobrew](https://github.com/abanoubha/gobrew).

## why I built this?

I found the post of the developer of gobrew and thought it was interesting to translate it to Rust. The post is called [Go vs Rust usage in Homebrew Core formulae on my website](https://abanoubhanna.com/posts/go-vs-rust-use-production/) and I would recommend reading it, if you haven't yet.
...
```sh
$ cargo run --release -- -l python@3.12
718

$ cargo run --release -- -l python@3.11
67

$ cargo run --release -- -l python@3.10
10

$ cargo run --release -- -l python@3.9
6

$ cargo run --release -- -l python@3.8
2
```
...
- [x] get count of packages which are written/built in Rust language
...
- [x] re-download Homebrew/Core formulae index JSON file if the local one is older than 7 days
